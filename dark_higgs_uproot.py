...
e_sfTrigg[e_counts>0] =  evaluator["hEffEtaPt"](loose_electrons.eta[e_counts>0,0], loose_electrons.pt[e_counts > 0,0])
...
print evaluator["IsoMu24_OR_IsoTkMu24_PtEtaBins/abseta_pt_ratio"](loose_muons.eta[m_counts>0,0], loose_muons.pt[m_counts > 0,0])
